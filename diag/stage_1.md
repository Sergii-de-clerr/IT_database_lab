...
3. Потік подій для прецедента «Зробити проекцію таблиці»<br/><br/>
Передумова: користувач відкрив таблицю БД для перегляду.<br/>
1. Користувач обирає опцію «Зробити проекцію таблиці» (А1).<br/>
2. Користувач задає атрибути, по яким робиться проекція.<br/>
3. Користувач натискає кнопку «Створити» (А2).<br/>
4. Система виводить проекцію таблиці по заданих атрибутах.<br/>
5. Варіант використання завершується.<br/>
Альтернативні потоки:<br/><br/>
А1. Повернення в головне меню<br/><br/>
1. Користувач натискає кнопку «Назад».<br/>
2. Потік повертається до етапу 1 основного потоку.<br/><br/>
А2. Атрибути не задані<br/>
1. Система виводить повідомлення про необхідність задати хоча б один атрибут для здійснення проекції.<br/>
